...
|Key|Type|Required|概要|
|---|---|---|---|
|Ekimei|String (Property)|Required|駅名を表します。この項目は必須です。|
...
`Ekijikoku Property`はカンマ区切りの1次元配列の値として表されます。
...
|Key|Type|Required|概要|
|---|---|---|---|
|JikokuhyouFont|[FontProp](#fontprop-property)\[\] (Property)|Required|時刻表の列車時刻に使用されるフォント設定を表す|
|JikokuhyouVFont|[FontProp](#fontprop-property)\[\] (Property)|Optional|時刻表上の縦書き部分に使用されるフォント設定を表す|
|DiaEkimeiFont|[FontProp](#fontprop-property)\[\] (Property)|Optional|ダイヤグラム上の駅名表示に使用されるフォント設定を表す|
|DiaJikokuFont|[FontProp](#fontprop-property)\[\] (Property)|Optional|ダイヤグラム上の時刻表示に使用されるフォント設定を表す|
|DiaRessyaFont|[FontProp](#fontprop-property)\[\] (Property)|Optional|ダイヤグラム上の列車表示に使用されるフォント設定を表す|
|CommentFont|[FontProp](#fontprop-property)\[\] (Property)|Optional|コメントに使用されるフォント設定を表す|
|DiaMojiColor|[Color](#color-property)\[\] (Property)|Optional|ダイヤグラム上の文字表示に使用される文字色を表す|
|DiaHaikeiColor|[Color](#color-property)\[\] (Property)|Optional|ダイヤグラムの背景表示に使用される色を表す|
|DiaRessyaColor|[Color](#color-property)\[\] (Property)|Optional|ダイヤグラムの列車表示に使用される既定色を表す|
|DiaJikuColor|[Color](#color-property)\[\] (Property)|Optional|ダイヤグラムの軸表示に表示される色を表す|
|EkimeiLength|Unsigned Int (Property)|Optional|ダイヤグラム上の駅名表示欄の桁数を表す|
|JikokuhyouRessyaWidth|Unsigned Int (Property)|Optional|時刻表上での列車表示欄の桁数を表す|
|DiaRessyajouhouHyoujiEkiOrderKudari|String (Property)|Optional|(不明)|
|DiaRessyajouhouHyoujiEkiOrderNobori|String (Property)|Optional|(不明)|
